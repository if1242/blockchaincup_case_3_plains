...
const INITIAL_BALANCE: u64 = 23;
/// Initial details
///const INITIAL_DETAILS: Vec<Detail> = vec![Detail { name_of_type: 0, count: 10}];
/// Initial develop 
///const INITIAL_DEVELOP: Vec<Detail> = vec![Detail { name_of_type: 0, count: 10}];
